...
CREATE TABLE FIDE_PRODUCTOPROVEEDOR_TB(
    ...
    CONSTRAINT FIDE_PRODUCTOPROVEEDOR_ID_PRODUCTOPROVEEDOR_PRIMARY_KEY PRIMARY KEY,
    horarioEntrega VARCHAR2(1000),
    idProveedor NUMBER, 
    CONSTRAINT FIDE_PRODUCTOSPROVEEDOR_ID_PROVEEDOR_FOREIGN_KEY FOREIGN KEY(idProveedor) REFERENCES FIDE_PROVEEDORES_TB(idProveedor),
